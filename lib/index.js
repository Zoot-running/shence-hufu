...
var CampaignRegistry = class {
  ...
  register(campaign) {
    ...
    this.delivered.set(id, /* @__PURE__ */ new Set());
    return id;
  }
  get(id) {
...
function apply(ctx, config = {}) {
  ...
  ctx.tools.register(defineTool({
    ...
    description: "Create a hufu campaign (parallel scheduling ledger) and return its id. Slots are unlimited by default \u2014 backpressure comes only from CPU/RAM/provider rate limits; work items dispatch as soon as they are ready (DAG dependencies satisfied) and a slot is free.",
    parameters: {
